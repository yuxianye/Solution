$(function () {
    ...
    var service = solution.materials.productType;
    var createModal = new abp.ModalManager(abp.appPath + 'Materials/ProductType/CreateModal');
    var editModal = new abp.ModalManager(abp.appPath + 'Materials/ProductType/EditModal');
